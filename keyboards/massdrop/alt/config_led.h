...
//On Drop ALT, there is no significant difference when brightness is above 80
#define LED_GCR_MAX                 80          //Max GCR value (0 - 255) WARNING: Raising this value may overload the LED drivers and USB bus
